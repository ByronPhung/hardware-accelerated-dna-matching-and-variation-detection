...
#endif
static const char *ng0 = "D:/Documents/College/CalPolyPomona/SeniorProject/hardware-accelerated-dna-matching-and-variation-detection/Hardware/Verilog/Search_4Comparators.v";
static int ng1[] = {0, 0};
...
static int ng5[] = {4, 0};
static int ng6[] = {64, 0};
static int ng7[] = {1022, 0};
static int ng8[] = {1021, 0};
static int ng9[] = {1020, 0};
...
LAB39:    memcpy(t75, t53, 8);

LAB40:    memset(t103, 0, 8);
    t104 = (t75 + 4);
...
LAB42:    if (*((unsigned int *)t66) != 0)
        goto LAB43;

LAB44:    t76 = *((unsigned int *)t53);
...
LAB56:    if (*((unsigned int *)t116) != 0)
        goto LAB57;

LAB58:    t126 = *((unsigned int *)t103);
...
LAB14:    xsi_set_current_line(117, ng0);
    ...
    t23 = *((char **)t10);
    memset(t8, 0, 8);
    xsi_vlog_unsigned_multiply(t8, 32, t7, 32, t23, 8);
    memset(t40, 0, 8);
    xsi_vlog_unsigned_minus(t40, 32, t6, 32, t8, 32);
    t24 = ((char*)((ng6)));
    xsi_vlog_get_indexed_partselect(t30, 64, t3, ((int*)(t5)), 2, t40, 32, 2, t24, 32, 1, 0);
    t31 = (t0 + 2888);
...
LAB13:    xsi_set_current_line(109, ng0);
    ...
    t39 = *((char **)t38);
    memset(t40, 0, 8);
    xsi_vlog_unsigned_multiply(t40, 32, t36, 32, t39, 8);
    memset(t41, 0, 8);
    xsi_vlog_unsigned_minus(t41, 32, t35, 32, t40, 32);
    t42 = ((char*)((ng6)));
    xsi_vlog_get_indexed_partselect(t30, 64, t32, ((int*)(t34)), 2, t41, 32, 2, t42, 32, 1, 0);
    t43 = (t0 + 2888);
    xsi_vlogvar_assign_value(t43, t30, 0, 0, 64);
...
extern void work_m_00000000001733834982_3846110240_init()
{
	static char *pe[] = {(void *)Always_67_0,(void *)Always_105_1};
	xsi_register_didat("work_m_00000000001733834982_3846110240", "isim/Search_4Comparators_tf_isim_beh.exe.sim/work/m_00000000001733834982_3846110240.didat");
